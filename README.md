...
- **Endless folder palettes:** Each folder gets its own auto-generated color palette (surface/border/accent/text) using richer contrast-friendly hues so large grids stay visually scannable; when creating a folder from the popup you can also choose your own color.
- **Dark/light dashboard:** Toggle themes from the manager header; cards, menus, and folder colors adapt automatically for comfortable browsing in either mode.
