...
- When you click **“Smart bookmark this tab”**, the popup asks the background service worker to:
  ...
  2. Score the page against a weighted keyword map (software engineering, technology, finance/banking, business/work, education/learning, entertainment/media, news/politics, design/creative, science/health, shopping/reviews, travel/places, sports/fitness, faith/spirituality) using metadata/snippets first, URL-path cues second, and domain last, and fall back to **Unsorted** if no clear match exists.
